...
if(rpcData.donationvalue && rpcData.foundationvalue)
{//this stupid non-comformant AidBit shit
    for (var i = 0; i < recipients.length; i++){
        if(recipients[i].percent == 0 && i==0) {
 		var recipientReward = rpcData.donationvalue;
 	} else if(recipients[i].percent == 0 && i==1) {
 		var recipientReward = rpcData.foundationvalue;
 	} else {
